...
where $U(x)$ is the potential energy of a state $x$, $\beta$ is some thermal factor which is inversely proportional to a given temperature and $w(t)$ is the Brownian motion in $n$ dimensions\todo{define it}.
